        ...
        <div className="container custom-container1">
          <div className="row">
            <div className="col-md-12">
              ...
              <p className="theme-desc projects-theme-desc-p projects-custom-theme-desc projects-custom-margin-2 00  mb-4">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <p className="theme-desc projects-theme-desc-p projects-custom-theme-desc ">
                ...
                Projektując logo, tworzymy coś więcej niż znak – <span className="">budujemy fundamenty sukcesu</span> Twojej marki.
              </p>
            </div>
          </div>
        </div>
