...
const LogoBanner = ({ openModal }) => {
  ...
  <span className="indent-60">Zaufanie</span>
              ...
              Gwarantujemy 100% satysfakcji</span> – tworzymy, aż Cię zachwycimy
              </h2>
              <p>"<span className="underlineText">
              Twoje logo jest wizytówką</span> Twojej marki. Powinno inspirować zaufanie od pierwszego spojrzenia." - Laura Busche</p>
