            ...
            <div className="copywriting-white-text-cont col-md-7">
              ...
              <div>
                ...
                >
                  ...
                  <span className="orange-link" style={{ color: '#00BFFF', borderBottomColor:'#00BFFF' , fontFamily: 'Roboto, sans-serif', fontWeight: 400, fontSize: '16px', lineHeight: '21px' }}>
                      <strong>Kliknij tutaj, aby pobrać (PDF)</strong>
                    </span>
                </a>
              </div>
            </div>
