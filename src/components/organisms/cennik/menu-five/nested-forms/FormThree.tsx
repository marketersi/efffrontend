...
const UserDetailsSection = () => {
  ...
  const { formFour } = screenData?.cardMenu?.menuFifth || "";
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      type: 5,
      tbl_fifthpricecard_dropdwonoption_id: formData.formZeroDropdownValueOne,
      tbl_fifth_price_range_id: formData.formOneSelectedRangeValue,
